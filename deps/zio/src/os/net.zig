    ...
    switch (builtin.os.tag) {
        .windows => {
            ...
            return switch (err) {
                ...
                // Linux epoll SO_ERROR may surface EPIPE for peer-closed sockets.
                // Treat it as a connection reset class error instead of Unexpected.
                .PIPE => error.ConnectionResetByPeer,
                .NOTSOCK => error.FileDescriptorNotASocket,
                .NOMEM => error.SystemResources,
                .CANCELED => error.Canceled,
                else => |e| unexpectedError(e),
